...
const { getJobData, getJobSchema, TOTAL_JOBS, jobTitles, companies, southAfricaLocations, industries } = require('./jobData');
...
<script>
  atOptions = {
    'key' : '211059ac9530a246efef275823da8000',
    'format' : 'iframe',
    'height' : 90,
    'width' : 728,
    'params' : {}
...
<script src="https://www.highperformanceformat.com/211059ac9530a246efef275823da8000/invoke.js"></script>
`;
...
/* NAV */
nav{background:#006b44;color:#fff;padding:0 1.5rem;display:flex;align-items:center;justify-content:space-between;height:60px;position:sticky;top:0;z-index:100}
nav .brand{font-size:1.25rem;font-weight:700;color:#f7b731}
...
nav .nav-links a:hover{color:#f7b731}
/* HERO */
.hero{background:linear-gradient(135deg,#006b44 0%,#004d33 50%,#003d29 100%);color:#fff;padding:3rem 1.5rem;text-align:center}
.hero h1{font-size:clamp(1.6rem,4vw,2.8rem);font-weight:800;margin-bottom:.75rem}
.hero h1 .accent{color:#f7b731}
...
.stat{text-align:center}.stat strong{display:block;font-size:1.5rem;color:#f7b731}
...
.search-bar input:focus,.search-bar select:focus{border-color:#006b44}
.search-bar button{padding:.6rem 1.4rem;background:#f7b731;color:#1a1a2e;border:none;border-radius:8px;cursor:pointer;font-weight:700;font-size:.9rem}
/* FILTERS */
...
.filter-chip.active,.filter-chip:hover{background:#006b44;color:#fff;border-color:#006b44}
/* LAYOUT */
...
.job-card:hover{border-color:#006b44;transform:translateY(-2px)}
...
.btn-apply{padding:.55rem 1.3rem;background:#006b44;color:#fff;border:none;border-radius:8px;font-weight:700;font-size:.85rem;cursor:pointer;transition:background .2s}
.btn-apply:hover{background:#004d33}
/* JOB DETAIL */
...
.btn-apply-big{padding:.85rem 2.5rem;background:#006b44;color:#fff;border:none;border-radius:10px;font-weight:700;font-size:1rem;cursor:pointer;transition:background .2s}
.btn-apply-big:hover{background:#004d33}
/* PAGINATION */
...
.pagination a:hover{border-color:#006b44;color:#006b44}
.pagination .current{background:#006b44;color:#fff;border-color:#006b44}
/* BREADCRUMB */
.breadcrumb{font-size:.82rem;color:#888;margin-bottom:1rem}
.breadcrumb a{color:#006b44}
/* SITEMAP NOTE */
.info-box{background:#fff;border-radius:12px;padding:1.25rem 1.5rem;border-left:4px solid #006b44;margin-bottom:1rem;font-size:.88rem}
/* FOOTER */
footer{background:#1a1a2e;color:rgba(255,255,255,0.7);text-align:center;padding:1.5rem;font-size:.82rem;margin-top:3rem}
footer a{color:#f7b731}
/* MODAL */
...
.modal input:focus{border-color:#006b44}
.modal .btn-submit{width:100%;padding:.75rem;background:#006b44;color:#fff;border:none;border-radius:8px;font-weight:700;cursor:pointer;font-size:.95rem}
.modal .btn-submit:hover{background:#004d33}
...
<div class="job-card">
  ...
  const body = `
<div class="hero">
  <h1>Find Your Dream Job in <span class="accent">South Africa</span></h1>
  <p>100,000 verified job listings — remote & on-site — across all 9 provinces</p>
  <form action="/jobs" method="get" style="display:flex;gap:.75rem;max-width:580px;margin:0 auto;flex-wrap:wrap">
    ...
    <button type="submit" style="padding:.7rem 1.5rem;background:#f7b731;color:#1a1a2e;border:none;border-radius:8px;font-weight:700;cursor:pointer">Search →</button>
  </form>
  <div class="stat-bar">
    ...
    <div class="stat"><strong>9</strong><span>Provinces Covered</span></div>
...
<div class="container">
  ${AD_MIDDLE}
  <div class="info-box">
    🇿🇦 South Africa's most comprehensive job board — browse <strong>50,000 remote jobs</strong> and <strong>50,000 on-site jobs</strong> across all industries.
  </div>
...
<div class="hero" style="padding:1.75rem 1.5rem">
  <h1 style="font-size:1.8rem">Browse <span class="accent">100,000 Jobs</span> in South Africa</h1>
...
<div class="container">
  ...
  <div class="job-detail">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:1rem">
      ...
      <div style="display:flex;flex-direction:column;align-items:flex-end;gap:.5rem">
        ...
        <span style="font-size:.8rem;color:#888">Job ID: ZA-${String(job.id).padStart(6, '0')}</span>
      </div>
    </div>
  ...
  <div style="text-align:center;margin-top:1.5rem">
    <a href="/jobs" style="color:#006b44;font-weight:600">← Browse All 100,000 Jobs</a>
  </div>
</div>`;
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1rem;margin-top:1rem">
    <div class="job-card">
      ...
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/" style="color:#006b44">🏠 Home</a>
        <a href="/jobs" style="color:#006b44">📋 All Jobs (100,000)</a>
        <a href="/jobs?type=remote" style="color:#006b44">🌐 Remote Jobs (50,000)</a>
        <a href="/jobs?type=onsite" style="color:#006b44">🏢 On-site Jobs (50,000)</a>
      </div>
    </div>
    <div class="job-card">
      <div class="card-title">XML Sitemaps</div>
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/sitemap.xml" style="color:#006b44">📄 Sitemap Index</a>
        <a href="/sitemap-1.xml" style="color:#006b44">📄 Sitemap 1 (Jobs 1–1,000)</a>
        <a href="/sitemap-2.xml" style="color:#006b44">📄 Sitemap 2 (Jobs 1,001–2,000)</a>
    ...
    <div class="job-card">
      ...
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/jobs/1" style="color:#006b44">Job #1 (First Remote Job)</a>
        <a href="/jobs/50000" style="color:#006b44">Job #50,000 (Last Remote Job)</a>
        <a href="/jobs/50001" style="color:#006b44">Job #50,001 (First On-site Job)</a>
        <a href="/jobs/100000" style="color:#006b44">Job #100,000 (Last On-site Job)</a>
      </div>
    </div>
  </div>
</div>`;
